...
def calculate_amount(principal, interest_rate, years):
    try:
        ...
        tk.messagebox.showwarning(
            "Incomplete info", "Make sure you type values for all fields"
        )
    except ValueError:
        tk.messagebox.showerror("Invalid input", "Make sure you type in numbers only")


title = tk.Label(app, text="Calculate interest rate", font=("Helvetica", 20))
title.pack(pady=5)
